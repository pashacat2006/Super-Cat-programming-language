...
export const tokenTypesList = {
    ...
    // List keywords — must be before VARIABLE so they aren't matched as identifiers
    "LIST":    new TokenType("LIST",    "list"),
    "PUSH":    new TokenType("PUSH",    "push"),
    "POP":     new TokenType("POP",     "pop"),
    "GETLIST": new TokenType("GETLIST", "getlist"),
    "SORT":    new TokenType("SORT",    "sort"),
    "ASC":     new TokenType("ASC",     "asc"),
    "DESC":    new TokenType("DESC",    "desc"),
    "FORE":    new TokenType("FORE",    "fore"),
